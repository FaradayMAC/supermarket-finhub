...
import { LayoutDashboard, Store, Receipt, Users, IdCard, CalendarX, Landmark, Target, Scale, Shield, LogOut, FileBarChart, Wallet, Briefcase, FileText, ShoppingCart, PackageSearch, CalendarClock, Banknote, Gauge, FileMinus } from "lucide-react";
